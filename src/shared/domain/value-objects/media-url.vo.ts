import { AVATAR_URL_REGEX, POST_MEDIA_URL_REGEX } from 'src/libs/regex';
...
export class MediaURL {
    ...
    public static create(value: string): MediaURL {
        const normalized = validateByRegex(
            value,
            [POST_MEDIA_URL_REGEX, AVATAR_URL_REGEX],
            'media-url',
        );
    ...
    public static isValid(value: string): boolean {
        return POST_MEDIA_URL_REGEX.test(value) || AVATAR_URL_REGEX.test(value);
    }
